...
class MiniGPT4(Blip2Base):
    ...
    def encode_img(self, image):
        ...
        with self.maybe_autocast():
            # print('self.visual_encoder(image)',self.visual_encoder(image).shape)
            ...
            # print('Qformer input shape',query_tokens.shape)
            ...
            # print('Qformer ourput shape',query_output.last_hidden_state.shape)
