...
class ALEvaluator:
    ...
    def eval_coco(self, preds:List[Dict] or str):
        ...
        for img_info in coco_annos['images']:
            ...
            frame = annotate(os.path.join("/mnt/vdb1/datasets/EvalADDataset/2cls_highshot", img_info['rel_path']), bboxes+gt_boxes, ['pred' for _ in bboxes] + ['gt' for _ in gt_boxes])
    ...
    #         gt.append(_gt)
    #         pred.append(_pred)
    #     print(np.array(pred).sum(),np.array(gt).sum())
...
if __name__ == '__main__':
    import csv
    result_file = "/home/lyz/vdb/results/lomo/shikra_vicuna-13b-v0_lomo/vegpt4_aug=Strong_stage3_finetune_adamw_hf_lr0.03_warmup0.1_clipnorm1.0/checkpoint-34/eval_results_20230815_100037.json"
    # result_file = "/home/ubuntu/lyz/experiments/ve_gpt4_aug=resize+crop_mask=aprilGAN/20230723012/eval_results_20230723_135742.json"
